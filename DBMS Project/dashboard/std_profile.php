...
<body>
                                ...
                                <form class="form-horizontal form-material" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" autocomplete="off">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $mis ?>" class="form-control p-0 border-0" name="mis" disabled> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $total_credits ?>" class="form-control p-0 border-0" name="tota$total_credits" disabled> </div>
                                    </div>
    ...
    <?php 
        if($done == 2) {
            $sql = "UPDATE student SET email = '".$email."', mobile = ".$mobile.", city = '".$city."' WHERE mis = ".$mis." ";
            if ($result = mysqli_query($conn, $sql)) {
                echo "<script>window.location.replace('std_profile.php');</script>";
            } else {
