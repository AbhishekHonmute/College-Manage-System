...
<body>
    <?php 
        ...
        $dob = $admin->dob;
        $read_data = 1;
        $course_id = $_SESSION['ad_course_view_id'];
        $title = "";
        $credits = "";
        $dept_id = "";
        $i_mis = "";
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" autocomplete="off">
                                    ...
                                    <p id="credits_err" style="color:red"><?php echo $dept_id_err ;?></p>
                                    <div class="form-group mb-4">
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ml-auto"><span class="counter text-success"><?php echo $total_students;?></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <?php 
        if($done == 4) {
            $sql = "UPDATE course SET title = '".$title."', credits = '".$credits."', dept_id = '".$dept_id."', i_mis = '".$i_mis."' WHERE course_id = '".$course_id."'";
        ...
        if (isset($_POST['submit'])) {
            if ($_POST['submit'] == "delete") {
                ...
                if ($result = $conn->query($sql)) {
                    ...
                    echo "<script>alert('Unable to delete Course as many other elements in this database depends on it!!');</script>";
