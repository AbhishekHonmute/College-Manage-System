...
<body>
                        ...
                        <div class="white-box">
                            <div class="row align-items-center">
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h2 class="page-title text-uppercase font-medium font-20">Students</h2>
                                </div>
                                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                                    <div class="d-md-flex">
                                        <ol class="breadcrumb ml-auto">
                                        </ol>
                                        <button onclick="add_std_handler()" target="_blank" class="btn btn-success  d-none d-md-block pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Add Student</button>
                                    </div>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = "SELECT mis, fname, lname, mobile, email, dept_id FROM student";
                                            if ($result = $conn->query($sql)) {
                                                if ($result->num_rows >= 1) {
                                                    // output data of each row
                                                    while($row = $result->fetch_assoc()) {
                                                        echo "<tr><td>" . $row["mis"]. "</td><td>" . $row["fname"]." ".$row['lname']."</td><td>" . $row["mobile"]. "</td><td>" . $row["email"]. "</td><td>" . $row["dept_id"]. "</td><td><button onclick='view(\"ad_std_view_id\", " . $row["mis"]. ", \"ad_std_view.php\")' class='btn btn-block btn-danger text-white'>View</button></td></tr>";
                                                    }
                                                }
                                            } else {
                                                echo "Query Failed";
    ...
    <script> 
        ...
        function add_std_handler() {
            window.location.replace("ad_add_std.php");
        }
    </script>
</body>
